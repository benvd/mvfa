...
/**
 * Container for a tabbed window view. This object holds two children: a set of tab labels that the user clicks to
 * select a specific tab, and a FrameLayout object that displays the contents of that page. The individual elements are
 * typically controlled using this container object, rather than setting values on the child elements themselves.
 */
public class TabHost extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener {
	...
	/**
	 * <p>
	 * Call setup() before adding tabs if loading TabHost using findViewById(). <i><b>However</i></b>: You do not need
	 * to call setup() after getTabHost() in {@link my.android.app.TabActivity TabActivity}. Example:
	 * </p>
	 * 
	 * <pre>
	...
	/**
	 * If you are using {@link TabSpec#setContent(android.content.Intent)}, this must be called since the activityGroup
	 * is needed to launch the local activity.
	 * 
	...
	/**
	 * Makes the content of a tab when it is selected. Use this if your tab content needs to be created on demand, i.e.
	...
	/**
	 * A tab has a tab indicator, content, and a tag that is used to keep track of it. This builder helps choose among
	 * these options.
	 * 
	 * For the tab indicator, your choices are: 1) set a label 2) set a label and an icon
	 * 
	 * For the tab content, your choices are: 1) the id of a {@link View} 2) a {@link TabContentFactory} that creates
	 * the {@link View} content. 3) an {@link Intent} that launches an {@link my.android.app.Activity}.
	 */
	public class TabSpec {
		...
		/**
		 * Specify a {@link my.android.widget.TabHost.TabContentFactory} to use to create the content of the tab.
		 */
		...
		// Added this as a convenient way to replace the content of the TabSpec when content is an Activity.
		// Tell the tab to close, destroy the underlying activity so it isn't in limbo, then recreate the tab
		// This could be done for other content types but for the purpose of this tutorial, I am only doing this.
	...
	private static interface ContentStrategy {
		...
		/**
		 * Perhaps do something when the tab associated with this content has been closed (i.e make it invisible, or
		 * remove it).
		 */
		void tabClosed();
	}
	...
	private class LabelIndicatorStrategy implements IndicatorStrategy {
		...
		public View createIndicatorView() {
			...
			View tabIndicator = inflater.inflate(R.layout.tab_indicator, mTabWidget, // tab widget is the parent
