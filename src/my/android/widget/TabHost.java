...
public class TabHost extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener {
    ...
    /**
      ...
      * in {@link my.android.app.TabActivity TabActivity}.
      * Example:</p>
...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
    ...
    {    	
    	TabWidget MyTabWidget = this.getTabWidget(); LinearLayout MyTabWidgetParent = (LinearLayout) MyTabWidget.getParent(); 
     ...
     * 3) an {@link Intent} that launches an {@link my.android.app.Activity}.
     */
    public class TabSpec {
        ...
        /**
         * Specify a {@link my.android.widget.TabHost.TabContentFactory} to use to
