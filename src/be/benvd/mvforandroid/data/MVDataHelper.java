...
public class MVDataHelper {
	...
	private static final String URL_USAGE = "https://mobilevikings.com/api/2.0/basic/usage.json";
	private static final String URL_CREDIT = "https://mobilevikings.com/api/2.0/basic/sim_balance.json";
	private static final String URL_TOPUPS = "https://mobilevikings.com/api/2.0/basic/top_up_history.json";
	...
	public static String getTestResponse(String username, String password, String url) throws ClientProtocolException,
		...
		if (url.equals(URL_CREDIT)) {
			return "{\"valid_until\": \"2010-07-21 21:38:00\", \"sms\": " + new Random().nextInt(1000) + ", \"data\": "
					+ new Random().nextInt(1073741824) + ", \"is_expired\": false, \"credits\": \""
					+ new Random().nextInt(40) + ".37\"}";
		} else
			if (url.equals(URL_USAGE)) {
